...
$sql = "select regno,name,dob,address,phno,email from student where regno= '$uid';";
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="/studentportel">Log out</a>
                </li>
                <!--<li>
                    <a href="#">Events</a>
                </li>
        ...
        <div id="viewprofile">
              <div class="row">
                ...
                <div class="col-sm-8 val" ><?php echo $row['regno']; ?></div>
              </div><br>
              <div class="row">
...
<form class="form-horizontal" action="./update_student.php">
  <div class="form-group">
      <label class="control-label col-sm-2" for="regno">Regno:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="regno" value="<?php echo $row['regno']; ?>" placeholder="Enter register number" name="regno" required disabled>
      </div>
    </div>
